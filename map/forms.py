...
class StateForm(forms.ModelForm):
    ...
    class Meta:
        ...
        labels = {
            ...
            'drivers_license_short_answer': _("Please explain."),
            'drivers_license_source': _("Source:"),
            'in_state_tuition': _("Can undocumented students access in-state tuition at public colleges?"),
            'in_state_tuition_short_answer': _("Please explain."),
            'in_state_tuition_source': _("Source:"),
            'barrier': _("Does immigration status act as a barrier in accessing state services?"),
            'barrier_short_answer': _("Please explain."),
            'barrier_source': _("Source:"),
